...
// internal is outside of the nestedFunction() scope so it can be accessed by that function
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(arr){
    /*Your Code Here*/
    const mapLowerCaseNames= arr.map((animal) => {
      return animal.animal_name.toLowerCase();
    })
    return mapLowerCaseNames;
  }
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    /*Your Code Here*/
    const filterLowPopAnimals = arr.map((animal) => {
      if(animal.population < 5) return animal;
    })
    return filterLowPopAnimals
  }
  ...
  */
  ...
  function USApop(arr){
    /*Your Code Here*/
    const reduceTotalPop = arr.reduce((total, animal) => {
      return total + animal.population;
    }, 0);
    return reduceTotalPop
  }
